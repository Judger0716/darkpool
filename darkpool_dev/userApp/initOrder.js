...
async function main() {
    ...
    try {
        ...
        let connectionProfile = yaml.safeLoad(fs.readFileSync('../organization/token/gateway/connection-org2.yaml', 'utf8'));
        ...
        let queryResponse = await contract.submitTransaction('Init');
