...
async function main() {
    ...
    try {
        ...
        const contract = await network.getContract('cc2', 'Committee');
        ...
        let queryResponse = await contract.submitTransaction('apply', '1');
        console.log(queryResponse.toString());
        console.log('\n  apply query complete.');
        console.log('-----------------------------------------------------------------------------------------\n\n');


        let queryResponse2 = await contract.evaluateTransaction('get_candidate');
        console.log(queryResponse2.toString());
        console.log('\n  get_candidate query complete.');
        console.log('-----------------------------------------------------------------------------------------\n\n');
